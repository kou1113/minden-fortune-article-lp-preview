(() => {
  ...
  const resultData = {
    wait: {
      ...
      prefix: '小さな優しさを大切にする',
      title: '期待を待つタイプ',
      description: '彼の言葉や態度を大切に思うほど、「次は彼から」と待ち続けて、自分の気持ちを後回しにしているのかもしれません。',
      traits: ['一途', '相手を尊重', '期待は慎重'],
      topics: ['彼が今抱えている気持ち', '二人の距離が動かない理由', '自分から伝える前に整理したいこと']
    },
    silence: {
      icon: '♡',
      code: 'LOVE TYPE · VEIL-S',
      prefix: '好きな気持ちを隠してしまう',
      title: '本音かくしタイプ',
      description: '今の関係を壊したくない気持ちが強く、好きという気持ちや不安を言えないまま、一人で抱え込んでいるようです。',
      traits: ['繊細', '空気を読む', '本音は慎重'],
      topics: ['言えない片思い', '相手との自然な距離の縮め方', '自分が本当に望んでいる関係']
    },
    bond: {
      icon: '✦',
      ...
      prefix: '忘れようと思っても',
      title: '想いを抱えるタイプ',
      description: '諦めようとしても、会ったり連絡をもらったりすると、やっぱり好きだと気づく。簡単には消せない大切な気持ちのようです。',
      traits: ['情が深い', '思い出を大切にする', '一途'],
      topics: ['この想いを伝えるかどうか', '好きでい続ける理由', '後悔しないための一歩']
    },
    future: {
      icon: '◇',
    ...
    complex: {
      ...
      topics: ['彼の本音と二人の未来', '片思いを伝えるタイミング', 'これから大切にしたい自分の気持ち']
    },
    steady: {
      icon: '☼',
  ...
  const axisMeta = {
    wait: { label: '期待して待つ', max: 9 },
    silence: { label: '本音を隠す', max: 9 },
    bond: { label: '想いを抱える', max: 6 },
